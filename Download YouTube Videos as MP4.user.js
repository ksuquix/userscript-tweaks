...
function run() {
  ...
  if (newWatchPage) {
    ...
    imageIcon.setAttribute('src', '//wayback.archive.org/web/20170224152250/https://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif');
  ...
  if (!newWatchPage) { // old UI
    ...
    imgButton.setAttribute('src', '//wayback.archive.org/web/20170224152250/https://s.ytimg.com/yt/img/pixel-vfl3z5WfW.gif');
...
/*
     FILE ARCHIVED ON 15:22:50 Feb 24, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 17:06:46 Mar 07, 2018.
